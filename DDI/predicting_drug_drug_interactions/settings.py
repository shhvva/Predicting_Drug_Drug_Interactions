...
ROOT_URLCONF = 'predicting_drug_drug_interactions.urls'
...
WSGI_APPLICATION = 'predicting_drug_drug_interactions.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'predicting_drug_drug_interactions',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
