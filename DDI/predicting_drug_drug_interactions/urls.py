"""predicting_drug_drug_interactions URL Configuration
...
from predicting_drug_drug_interactions import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Drug_To_Drug_Interact_Type/$', remoteuser.Predict_Drug_To_Drug_Interact_Type, name="Predict_Drug_To_Drug_Interact_Type"),
    ...
    url(r'^Find_Drug_To_Drug_Interact_Type_Ratio/$', serviceprovider.Find_Drug_To_Drug_Interact_Type_Ratio, name="Find_Drug_To_Drug_Interact_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^Predict_Drug_To_Drug_Interact_Type_Details/$', serviceprovider.Predict_Drug_To_Drug_Interact_Type_Details, name="Predict_Drug_To_Drug_Interact_Type_Details"),
